...
| A2 | Abstraction | fixed | (was Major) | The current table and tooltip show recorded n and a 95% Wilson interval, flag n < 30, and mark February 2026 partial. The earlier precise-coordinate column was removed because borough aggregates use the published borough field. |
