...
\path{figures/early_context/} (report folder) & Front-loaded figures: motivation borough map and linked-view wireframe; the earlier coordinate-uncertainty diagram is superseded by the \S\ref{sec:background-granularity} evidence-support matrix (Table~\ref{tab:evidence-support}). \\
